...
[ SRS ](https://git.chalmers.se/courses/dit355/test-teams-formation/team-8/team-8-project/-/blob/main/Documents/SRS.pdf)<br />
[ Final Report ](https://git.chalmers.se/courses/dit355/test-teams-formation/team-8/team-8-project/-/blob/main/Documents/Final%20Project%20Report,%20Group8.pdf)<br />
...
The component diagram describes the six components in the system with their name and how they communicate with each other. Each component subscribes and publishes to certain topics labeled by text in each connection.
There is no direct connections between components as the publisher publishes the message without knowing which component is going to receive it and the subscriber does not know where does the message come from.
